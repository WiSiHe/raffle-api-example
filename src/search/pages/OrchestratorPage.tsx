  ...
  const bullets = (
    <ul className="space-y-2 mt-2">
      <li className="flex items-center gap-2 text-sm text-nbim-midnight/70">
        ...
        Best for general fund questions and policy lookups.
      </li>
      <li className="flex items-center gap-2 text-sm text-nbim-midnight/70">
        <span className="w-1.5 h-1.5 rounded-full bg-nbim-sea" />
        The AI automatically picks the right data source for you.
      </li>
      <li className="flex items-center gap-2 text-sm text-nbim-midnight/70">
        <span className="w-1.5 h-1.5 rounded-full bg-nbim-sea" />
        Saves time by only searching what is necessary.
      </li>
    </ul>
  );
